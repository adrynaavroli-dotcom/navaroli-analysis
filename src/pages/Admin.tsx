...
import { Plus, LogOut, Pencil, Trash2, Eye, EyeOff, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8">
        ...
        {isLoading ? (
          ...
          <div className="bento-card p-12 text-center">
            <p className="text-muted-foreground mb-4">No theses yet</p>
            <Button
              onClick={() => {
                setEditingThesis(null);
                setDialogOpen(true);
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-muted/30">
                    ...
                    <th className="text-left p-4 font-medium text-sm hidden md:table-cell">Direction</th>
